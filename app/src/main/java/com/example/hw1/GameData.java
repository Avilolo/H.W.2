...
public class GameData {
    ...
    private void moveCroc(ShapeableImageView crocs[][], ShapeableImageView frogs[],
        ...
        if ((crocs[GameActivity.getFrogPos()][3].getVisibility() == View.VISIBLE) &&
                (crocs[GameActivity.getFrogPos()][3].getVisibility() == frogs[GameActivity.getFrogPos()].getVisibility())) {
